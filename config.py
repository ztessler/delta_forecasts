...
defaults = {
        ...
        'natural_subsidence_low_retention': '#data/experiments/{exp}/natural_subsidence_low.pd',
        'natural_subsidence': '#data/experiments/{exp}/natural_subsidence.pd',
        'natural_subsidence_high_retention': '#data/experiments/{exp}/natural_subsidence_high.pd',
        'natural_subsidence_all_retention': '#data/experiments/{exp}/natural_subsidence_all.pd',
